...
function App() {
  ...
  const [closingCostData, setClosingCostData] = useState({
    homePrice: '',
    downPaymentPercent: '',
    state: 'FL', // Florida for state-specific calculations
    ...
    propertyTaxRate: 1.5, // Annual property tax rate (Florida/Broward County default)
    homeInsurance: 2500, // Annual home insurance estimate (Florida higher due to hurricane risk)
    hoaFee: 0, // Monthly HOA/Condo fee
    sellerPaysClosing: false, // Whether seller is paying some closing costs
    sellerContribution: 0
  })

  // Property type insurance defaults (South Florida typical ranges)
  const propertyInsuranceDefaults = {
    'single-family': 2500, // $2,000-$3,500/year (higher due to hurricane risk)
    'townhome': 1800, // $1,500-$2,500/year
    'condo': 1200 // $1,000-$1,800/year (HOA master policy covers building, but wind/flood higher)
  }
  ...
  const countyTaxRates = {
    'FL': {
      // South Florida & Broward County Areas
      'Broward County': 1.5,
      'Plantation': 1.5,
      'Fort Lauderdale': 1.6,
      'Pompano Beach': 1.5,
  ...
  useEffect(() => {
    const calculateClosingCosts = () => {
      ...
      // Appraisal (South Florida: $400-$700+, varies by property size)
      const appraisal = homePrice > 750000 ? 700 : 500
      
      // Home Inspection (South Florida: $400-$800)
      const inspection = 600 // Average
      
      // Title Insurance (varies by state and loan amount)
      // Florida: ~0.5-0.7% of loan amount (similar to Texas)
      let titleInsuranceRate = 0.006 // Florida average
      const titleInsurance = loanAmount * titleInsuranceRate
      
      // Recording Fees (varies by state)
      // Florida: typically $50-300 depending on county
      let recordingFees = 200 // Florida/Broward average
      
      // Transfer Tax (varies significantly by state/county)
      // Florida: Documentary stamp tax - typically paid by seller, but can be negotiated
      // Documentary stamp tax is $0.70 per $100 of sale price, usually paid by seller
      // Some counties may have additional transfer fees
      let transferTax = 0 // Typically paid by seller in Florida, but can be negotiated
  ...
  const exportClosingCosts = () => {
    ...
    const accentColor = [86, 130, 177] // #5682B1
    const darkColor = [0, 0, 0] // #000000
    const grayColor = [113, 128, 150] // #718096
    const lightGrayColor = [255, 232, 219] // #FFE8DB
    ...
    // Subtitle
    addText('Reese Chase | Real Estate Consultant', pageWidth / 2, yPosition, {
      fontSize: 12,
      color: grayColor,
      align: 'center'
    })
    ...
    addText('Generated by Reese Chase - Home Buyer Consultation', pageWidth / 2, yPosition, {
      fontSize: 9,
      color: grayColor,
      align: 'center'
    })
...
This email was sent from your website contact form via Brevo.
  ...
  return (
    <div className="landing-page">
        ...
        <div className="hero-content">
          <div className="hero-layout">
            ...
            >
              ...
              <p className="hero-subtitle">Buying | Selling | Investment Properties</p>
              <p className="hero-location">Serving South Florida • Plantation • Fort Lauderdale • Pompano Beach</p>
              <motion.button 
            ...
            >
              <img 
                src="/images/reese-chase-profile-image.jpg" 
                alt="Reese Chase - Expert Real Estate Consultant for Home Buyers in South Florida"
      ...
      <section className="marquee-section">
        <div className="marquee-container">
          <div className="marquee-content">
            <span className="marquee-item">$50M+ in Sales • Broward County Expert</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">Compass • The Hopkins Team</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">South Florida Specialist • Plantation • Fort Lauderdale • Pompano Beach</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">Investment Property Expert • Renovation Specialist</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">Real Estate Consultant • Licensed in Florida</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">Buying • Selling • Investment Properties</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">First-Time & Repeat Buyer Expert</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">Serving South Florida & Broward County</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">$50M+ in Sales • Broward County Expert</span>
            <span className="marquee-dot">•</span>
            <span className="marquee-item">Compass • The Hopkins Team</span>
      ...
      <motion.section 
        id="areas-served" 
        className="areas-served fade-in-section"
      ...
      >
        <div className="container">
          <h2 className="section-title">Areas We Serve in South Florida</h2>
          <p className="section-subtitle">Licensed in Florida - serving Broward County and surrounding South Florida areas</p>
          <div className="locations-grid">
            <div className="location-card">
              <h3 className="location-title">Broward County Cities</h3>
            ...
            <div className="location-card">
              <h3 className="location-title">Additional Areas</h3>
              <ul className="location-list">
                <li>Tamarac</li>
                <li>Sunrise</li>
                <li>Lauderhill</li>
                <li>Dania Beach</li>
                <li>And all Broward County areas</li>
              </ul>
            </div>
            <div className="location-card">
              <h3 className="location-title">Extended South Florida Service Area</h3>
              <ul className="location-list">
                <li>Broward County</li>
                <li>Miami-Dade County</li>
                <li>Palm Beach County</li>
                <li>All South Florida communities</li>
                <li>Investment properties throughout Florida</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div className="money-card">
              ...
              <ul className="cost-list">
                ...
                <li>
                  ...
                  <div>
                    <strong><span className="tooltip-trigger" data-tooltip="Closing Costs: Fees paid at settlement including appraisal, inspection, title insurance, loan origination, and recording fees. Typically 2.5-3% of home price in South Florida.">Closing Costs</span></strong>
                    <span>~2.5% - 3%</span>
                  </div>
                </li>
                <li>
      ...
      <section id="closing-cost-calculator" className="closing-cost-calculator fade-in-section">
        <div className="container">
          ...
          <p className="section-subtitle">
            Estimate your total closing costs and cash needed to buy a home in South Florida. 
              ...
              <div className="calc-input-group">
                ...
                <div className="select-wrapper">
                  ...
                  >
                    ...
                    {closingCostData.state === 'FL' && (
                      <>
                        {/* South Florida & Broward County Areas */}
                        <optgroup label="South Florida & Broward County">
              ...
              <div className="closing-cost-breakdown">
                ...
                <div className="breakdown-list">
                  ...
                  <div className="breakdown-item">
                    <div className="breakdown-item-label">
                      <span>Appraisal</span>
                      <span className="tooltip-icon" data-tooltip="A professional assessment of the home's value by a licensed appraiser. Required by lenders to ensure the property is worth the loan amount. In South Florida, typically costs $400-$700+ depending on property size.">
                        <Info size={14} />
                      </span>
                    </div>
                  ...
                  <div className="breakdown-item">
                    <div className="breakdown-item-label">
                      ...
                      <span className="tooltip-icon" data-tooltip="A professional evaluation of the property's condition, including structural elements, systems (HVAC, plumbing, electrical), and safety concerns. In South Florida, typically costs $400-$800. Allows you to negotiate repairs or withdraw if major issues are found.">
                        <Info size={14} />
                      </span>
                    </div>
                  ...
                  <div className="breakdown-item">
                    <div className="breakdown-item-label">
                      ...
                      <span className="tooltip-icon" data-tooltip="A tax on the transfer of property ownership. Florida: Documentary stamp tax is typically paid by the seller at $0.70 per $100 of sale price, but this can be negotiated in the contract.">
                        <Info size={14} />
                      </span>
                    </div>
                    ...
                    <>
                      ...
                      <div className="breakdown-item">
                        <div className="breakdown-item-label">
                          ...
                          <span className="tooltip-icon" data-tooltip="First year of homeowners insurance paid upfront. Required by lenders to protect their investment. Typical range in South Florida: $2,000-$3,500 per year depending on home value and coverage (higher due to hurricane risk).">
                            <Info size={14} />
                          </span>
                        </div>
        ...
        <div className="container">
          ...
          <div className="offer-components-grid">
            <div className="offer-component-card">
              ...
              <p className="component-description">
                <strong>Typical timeframe:</strong> 21-45 days is most common in South Florida, though it can range from 15-90 days depending on the seller's needs. <strong>As your realtor, I'll help you negotiate the best closing date for your situation.</strong>
              </p>
              </div>
            </div>
            ...
            <div className="offer-component-card">
              ...
              <p className="component-description">
                <strong>Market average in South Florida:</strong> 1-5% of purchase price. 3% EMD is the standard. The larger the EMD, the more security the seller has that you'll move forward to settlement.
              </p>
              <p className="component-description">
            ...
            <div className="offer-component-card">
              ...
              <p className="component-description" style={{ marginTop: '1rem', fontStyle: 'italic', color: '#ec4899', fontWeight: '600' }}>
      ...
      <motion.section 
        id="team-advantage" 
        className="team-advantage fade-in-section"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.3 }}
        transition={{ duration: 0.6 }}
        ...
        <div className="container">
          ...
          >
            ...
            >
              ...
              <div className="stat-label">In Sales Volume</div>
            </motion.div>
            <motion.div 
              className="stat-card"
              whileHover={{ scale: 1.05, y: -5 }}
            ...
            <motion.div 
              ...
              transition={{ duration: 0.2 }}
            >
              <div className="stat-number">Broward</div>
              <div className="stat-label">County Expert</div>
            </motion.div>
            <motion.div 
              className="stat-card"
              whileHover={{ scale: 1.05, y: -5 }}
              transition={{ duration: 0.2 }}
            >
              <div className="stat-number">Compass</div>
              <div className="stat-label">The Hopkins Team</div>
            </motion.div>
          </motion.div>
          <p className="team-text">
            When you work with me as your realtor, you're working with Reese Chase at Compass on The Hopkins Team. I got my start in real estate by renovating investment properties, learning the ins and outs of buying and selling through hands-on experience. Today, I use that expertise to help sellers maximize their home's value and guide buyers through every step of the process — from negotiations to post-purchase remodeling. Born and raised in Plantation, Florida, I specialize in Plantation, Fort Lauderdale, and Pompano Beach, with over $50 million in real estate sales across Broward County.             <strong>Let's work together to find your perfect home.</strong>
          </p>
        </div>
      </motion.section>
        ...
        <div className="container">
          ...
          <div className="family-grid">
            ...
            <div className="family-card">
              ...
              <p className="family-description">
                We love the South Florida area. For every referral we receive, we give back to our local community.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="faq" className="faq fade-in-section">
        <div className="container">
          ...
          <p className="section-subtitle">Everything you need to know about buying a home in South Florida</p>
          <div className="faq-list">
            ...
            <div className={`faq-bar ${openFaq === 10 ? 'open' : ''}`}>
              ...
              <div className="faq-answer-content">
                <p className="faq-answer">
                  Yes! There are several first-time home buyer programs available in Virginia that can help with down payment assistance, lower interest rates, and reduced closing costs. These programs include options like FHA loans, VA loans (for eligible veterans), and Virginia-specific programs like the Virginia Housing Development Authority (VHDA) programs, which offer down payment assistance and competitive interest rates. As your realtor, I'll connect you with mortgage lenders who can provide detailed information about first-time home buyer programs you may qualify for. <strong>Ask me more about first-time buyer programs in Virginia.</strong>
                </p>
              </div>
            </div>
            <div className={`faq-bar ${openFaq === 11 ? 'open' : ''}`}>
              <button className="faq-question-bar" onClick={() => toggleFaq(11)}>
                <span>What are the best neighborhoods for home buyers in South Florida?</span>
                <ChevronDown className={`faq-icon ${openFaq === 11 ? 'open' : ''}`} size={20} />
              </button>
              <div className="faq-answer-content">
                <p className="faq-answer">
                  South Florida offers excellent neighborhoods across Broward County. Plantation, Fort Lauderdale, and Pompano Beach are my primary areas of expertise, each with unique character and price points. Plantation offers family-friendly communities with great schools, Fort Lauderdale provides urban living with waterfront options, and Pompano Beach offers coastal living at more accessible prices. Davie, Weston, and Coral Springs also offer fantastic options for families. Each area has unique character, price points, and amenities. As your realtor, I'll help you find the best neighborhood that fits your budget, lifestyle, and commute needs. <strong>Let's work together to explore the best neighborhoods for you.</strong>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="glossary-grid">
            ...
            <div className="glossary-item">
              ...
              <p className="glossary-definition">A good-faith deposit showing you're serious about buying. Held in escrow and credited back at closing. Typically 1-5% of purchase price in South Florida.</p>
            </div>
            <div className="glossary-item">
            ...
            <div className="glossary-item">
              ...
              <p className="glossary-definition">A tax paid when property ownership is transferred. Florida: Documentary stamp tax is typically paid by the seller at $0.70 per $100 of sale price, but this can be negotiated in the contract.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="includes-content">
              <ul className="includes-list">
                ...
                <li className="includes-item">
                  ...
                  <span><strong>Richmond Market Insights</strong> - Get expert analysis of current market conditions in your target neighborhoods</span>
                </li>
                <li className="includes-item">
                ...
                <li className="includes-item">
                  ...
                  <span><strong>All Your Real Estate Questions Answered</strong> - Get expert answers to any questions you have about buying a home, the Richmond market, neighborhoods, financing, or the home buying process</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-info">
              <p className="footer-name">Reese Chase | Real Estate Consultant</p>
              <p className="footer-license">South Florida • Compass • The Hopkins Team</p>
              <div className="footer-contact">
                <a href="mailto:reese.chase@compass.com" className="footer-email">reese.chase@compass.com</a>
                <a href="tel:9544946845" className="footer-phone">(954) 494-6845</a>
              </div>
            </div>
      ...
      {showPhotoModal && (
        ...
        >
          ...
          >
            <img 
              src="/images/reese-chase-profile-image.jpg"
              alt="Reese Chase - Real Estate Consultant"
